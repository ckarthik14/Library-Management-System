...
public class GiveReviewForm extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (usn != null)
		{
			...
			if(request.getAttribute("reviewfail") == "true")
				out.println("<h4> Unable to give review at this time, please try again </h4>");
			
			else
				out.println("<h4> Review submitted successfully </h4>");
